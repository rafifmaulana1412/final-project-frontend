...
const auth = {
  login: async (email, password) =>
    (await instance.post("/auth/login", { email, password })).data,
  register: async (data) =>
    (await instance.post("/auth/register", data)).data,
};
...
const categories = {
  ...
  create: async (data) => (await instance.post("/categories", data)).data,
  update: async (id, data) =>
    (await instance.put(`/categories/${id}`, data)).data,
  delete: async (id) => (await instance.delete(`/categories/${id}`)).data,
};
...
const cart = {
  ...
  addItem: async (menuId, quantity) =>
    (await instance.post("/cart/add", { menuId, quantity })).data,
